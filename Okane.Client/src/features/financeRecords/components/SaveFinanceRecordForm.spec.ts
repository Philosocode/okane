...
import SaveFinanceRecordForm from '@features/financeRecords/components/SaveFinanceRecordModalContent.vue'
...
describe('with a valid form state', () => {
  ...
  test('creates a finance record', async () => {
    ...
    expect(postRequestSpy).toHaveBeenCalledWith(
      ...
      mapSaveFinanceRecordFormState.to.preCreationFinanceRecord(formState),
    )
  })
